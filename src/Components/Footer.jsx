function Footer() {
    return (
        ...
        <section className="">
            ...
            <div className="row mt-3">
                ...
                <h6 className="text-uppercase fw-bold mb-4">
                    <i className="fas fa-gem me-3"></i>Beauty Queen
                </h6>
                <p>
                    Here you can use rows and columns to organize your div content. Lorem ipsum
        ...
        {/* <!-- Copyright --> */}
        <div className="text-center p-4 copyrightDiv" >
            © 2023 Copyright
        </div>
        {/* <!-- Copyright --> */}
        </div>
